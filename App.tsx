            ...
            <div className="flex flex-col gap-3 w-full max-w-[280px] pointer-events-auto">
                ...
                <div className="grid grid-cols-2 gap-3 w-full">
                    ...
                    {user ? (
                        ...
                        <>
                             <button onClick={loginWithGoogleRedirect} className="col-span-2 py-3 bg-white hover:bg-stone-100 text-stone-900 border-2 border-stone-900 font-bold text-lg shadow-[3px_3px_0px_rgba(0,0,0,0.3)] active:translate-y-1 active:shadow-none transition-all flex items-center justify-center gap-2">
